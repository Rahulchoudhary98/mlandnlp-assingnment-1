...
def interactive_prediction(model, tokenizer):
    """Interactive function to test next word predictions"""
    print("\n" + "="*50)
    ...
    while True:
        ...
        try:
            predictions = predict_next_words(model, tokenizer, text, num_predictions=5)
...
for text in example_texts:
    predictions = predict_next_words(model, tokenizer, text, num_predictions=3)
    print(f"\nInput: '{text}'")
...
print("SAVING MODEL")
print("="*50)
model.save_pretrained("./gpt2_nextword_final")
tokenizer.save_pretrained("./gpt2_nextword_final")
print("Model and tokenizer saved to './gpt2_nextword_final'")
